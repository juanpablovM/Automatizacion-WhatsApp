...
VALUES
  ...
  ('escalation_required', 'Escalacion Requerida', 'La conversacion requiere intervencion humana por excepcion, frustracion o bloqueo del flujo.', 50, TRUE),
  ('inactive_timeout', 'Inactiva por Tiempo', 'La conversacion quedo inactiva por expiracion operativa.', 60, TRUE),
  ('closed', 'Cerrada', 'La conversacion se cerro operativamente.', 70, TRUE),
  ('error', 'Error', 'La conversacion encontro un error de proceso o integracion.', 80, TRUE)
