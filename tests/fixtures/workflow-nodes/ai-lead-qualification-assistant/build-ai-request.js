...
const responseSchema = {
  ...
  properties: {
    ...
    modality: {
      ...
      description: 'Modalidad principal solicitada: solo material, retiro, despacho, instalacion, postventa o reclamo.',
    },
    sales_stage: {
      type: 'string',
    ...
    explicitly_mentioned_fields: {
      ...
      items: {
        type: 'string',
        enum: ['service', 'city', 'requirement'],
      },
      description: 'Lista de campos que el usuario menciono explicitamente en su mensaje actual.',
    },
    field_updates: {
      type: 'object',
      additionalProperties: false,
...
const systemPrompt = [
  ...
  '- Material/venta: obligatorios = producto, cantidad, comuna, modalidad (material/despacho/retiro). Condicionales: fecha estimada, factura.',
